...
This project presents an interactive Power BI dashboard built using the Netflix Movies and TV Shows dataset. The goal of this project is to analyze content trends, distribution, and key insights to support data-driven decision-making.

🔹 Dataset
- Source: Netflix Movies & TV Shows dataset (Excel)
...
- Creating meaningful KPIs and visual storytelling
